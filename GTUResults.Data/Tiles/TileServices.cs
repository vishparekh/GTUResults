...
namespace GTUResults.Services
{
    public class TileServices
    {
        static public void CreateFlipTile(string title, string content)
        {
            ...
            SetTileImages(squareTileXml, "ms-appx:///Assets/DataImages/FlipWideTile.png");
        ...
        static public void CreateIconicTile(string content1, string content2, string content3)
        {
            ...
            SetTileImages(squareTileXml, "ms-appx:///Assets/DataImages/IconicWideTile.png");
